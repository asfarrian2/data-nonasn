      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="/admin/dashboard" class="site_title"><span>DATA NON-ASN</span></a>
            </div>
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                <li><a href="/panel/home"><i class="fa fa-home"></i>Home</a></li>
                <br> <h3>MASTER</h3> <br>
                <li><a href="/panel/data-nonasn/view"><i class="fa fa-users"></i> Data Non-ASN</a></li>
                <br> <h3>TRANSAKSI</h3> <br>
                <li><a href="/panel/sk/view"><i class="fa fa-file"></i> Data SK</a></li>
                <br> <h3>OUTPUT</h3> <br>
          ...
          <div class="nav_menu">
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" style="padding-left: 15px;">
                  ...
                  <img src="/logo/user.png" alt="">{{ Auth::guard('user')->user()->name }}
                  </a>
                  <div class="dropdown-menu dropdown-usermenu pull-right" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item"  href="javascript:;"> Profil</a>
                    <a class="dropdown-item"  href="/panel/proseslogout"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
                  </div>
                </li>
              </ul>
            </nav>
        ...
        <footer>
          <div class="pull-right">
            Copyright &copy; 2025 BALAI PELATIHAN KOPERASI DAN USAHA KECIL PROV. KALIMANTAN SELATAN<a href="https://colorlib.com"></a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
